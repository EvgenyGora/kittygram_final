[![.github/workflows/main.yml](https://github.com/EvgenyGora/kittygram_final/actions/workflows/main.yml/badge.svg)](https://github.com/EvgenyGora/kittygram_final/actions/workflows/main.yml)
...
```bash 
git clone git@github.com:EvgenyGora/kittygram_final.git
```
